# C++ Driver for CrossDB

This driver refers [MySQL Connector/C++](https://github.com/mysql/mysql-connector-cpp), which follows [JDBC](https://docs.oracle.com/javase/tutorial/jdbc/basics/index.html) style
